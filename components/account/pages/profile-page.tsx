...
//               (!isEditing ? "No Name Provided" : "")
//             }
//             email={formData.email || (!isEditing ? "No Email Provided" : "")}
//             phone={formData.phone || (!isEditing ? "No PhoneNumber Provided" : "")}
//             location={formData.location || (!isEditing ? "No City Provided" : "")}
//             street={formData.street || (!isEditing ? "No Address Provided" : "")}
//             postalCode={formData.postalCode || (!isEditing ? "No PostalCode Provided" : "")}
//             states={formData.state || (!isEditing ? "No State Provided" : "")}
//             age={formData.age || (!isEditing ? "No Age Provided" : "")}
//             height={formData.hight || ""}
//             weight={formData.weight || (!isEditing ? "No Weight Provided" : "")}
//             shoeSize={formData.shoeSize || (!isEditing ? "No Shoe Size Provided" : "")}
//             avatarUrl={avatarUrl}
