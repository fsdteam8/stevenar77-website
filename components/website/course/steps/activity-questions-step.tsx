...
export function ActivityQuestionsStep() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-6 text-[#343a40]">Activity Specific Questions</h2>

      <div className="space-y-6">
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <Label className="text-base font-medium mb-3 block">Swimming...</Label>
          ...
          <div>
            <Label className="text-base font-medium mb-3 block">Diving Experience</Label>
            <div className="space-y-2">
        ...
        <div>
          <Label htmlFor="physical-exam">Date of Last Physical Examination</Label>
          <Input
            id="physical-exam"
        ...
        <div>
          <Label className="text-base font-medium mb-3 block">Fitness Level</Label>
