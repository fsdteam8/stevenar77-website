...
//       const logoBase64 = await fetchImageAsBase64("/images/trainning.png");
//       pdf.addImage(logoBase64, "PNG", margin, yPosition, 40, 40);
...
//       );
//       yPosition += 8;
//       pdf.text("ENRICHED AIR (NITROX) DIVER TRAINING", margin, yPosition);
//       yPosition += 15;
...
//       pdf.setFont("helvetica", "normal");
//       const liabilityText = `I, ${participantName}, hereby affirm that I am aware that scuba diving has inherent risks which may result in serious injury or death, and am aware of the particular hazards of scuba diving with oxygen enriched air.

// I understand that diving with compressed air involves certain inherent risks; including but not limited to decompression sickness, embolism or other hyperbaric/air expansion injury that require treatment in a recompression chamber. I also understand that diving with oxygen enriched air ("Enriched Air") involves inherent risks of oxygen toxicity and/or improper mixtures of breathing gas. I further understand that the open water diving trips which are necessary for training and for certification may be conducted at a site that is remote, either by time or distance or both, from such a recompression chamber. I still choose to proceed with such instructional dives in spite of the possible absence of a recompression chamber in proximity to the dive site.

// I understand and agree that neither my instructor(s), the facility through which I receive my instruction, ${storeResort}, nor PADI Americas, Inc., nor its affiliate and subsidiary corporations, nor any of their respective employees, officers, agents, contractors or assigns (hereinafter referred to as "Released Parties,") may be held liable or responsible in any way for any injury, death or other damages to me, my family, estate, heirs or assigns that may occur as a result of my participation in this diving program or as a result of the negligence of any party, including the Released Parties, whether passive or active.`;

//       const liabilityLines = pdf.splitTextToSize(liabilityText, contentWidth);
//       // if (yPosition + liabilityLines.length * 4 > pageHeight - 60) {
//       //   pdf.addPage()
//       //   yPosition = margin
//       // }
//       pdf.text(liabilityLines, margin, yPosition);
//       yPosition += liabilityLines.length * 4 + 10;

//       // Continue with more liability text...
//       const additionalText = `In consideration of being allowed to participate in this course, I hereby personally assume all risks of this program, whether foreseen or unforeseen, that may befall me while I am a participant in this program including all risks connected therewith, whether foreseen or unforeseen.

// I further release, exempt and hold harmless said course and Released Parties from any claim or lawsuit by me, my family, estate, heirs or assigns, arising out of my enrollment and participation in this course including both claims arising during the course or after I receive my certification.

// I also understand that scuba diving is a physically strenuous activity and that I will be exerting myself during this course, and that if I am injured as a result of heart attack, panic, hyperventilation, drowning or any other cause, that I expressly assume the risk of said injuries and that I will not hold the Released Parties responsible for the same.
...
//       const additionalLines = pdf.splitTextToSize(additionalText, contentWidth);
//       if (yPosition + additionalLines.length * 4 > pageHeight - 60) {
//         pdf.addPage();
//         yPosition = margin;
//       }
//       pdf.text(additionalLines, margin, yPosition);
//       yPosition += additionalLines.length * 4 + 15;
...
//       const finalText = `I understand and agree that I am not only giving up my right to sue the Released Parties but also any rights my heirs, assigns, or beneficiaries may have to sue the Released Parties resulting from my death. I further represent I have the authority to do so and that my heirs, assigns, or beneficiaries will be estopped from claiming otherwise because of my representations to the Released Parties.

// I, ${participantName}, BY THIS INSTRUMENT AGREE TO EXEMPT AND RELEASE MY INSTRUCTORS, THE FACILITY THROUGH WHICH I RECEIVE MY INSTRUCTION, ${storeResort}, AND PADI AMERICAS, INC., AND ALL RELATED ENTITIES AS DEFINED ABOVE, FROM ALL LIABILITY OR RESPONSIBILITY WHATSOEVER FOR PERSONAL INJURY, PROPERTY DAMAGE OR WRONGFUL DEATH, HOWEVER CAUSED, INCLUDING BUT NOT LIMITED TO THE NEGLIGENCE OF THE RELEASED PARTIES, WHETHER PASSIVE OR ACTIVE.
...
//       yPosition += finalLines.length * 4 + 20;
...
//       pdf.setFont("helvetica", "normal");
//       pdf.setFontSize(12);
//       pdf.text(participantName, margin, yPosition + 15);
//       pdf.line(margin, yPosition + 20, margin + 170, yPosition + 20);
//       pdf.setFontSize(8);
//       pdf.text("Participant Name (PLEASE PRINT)", margin, yPosition + 25);
...
//       pdf.line(margin, yPosition + 20, margin + 120, yPosition + 20);
//       pdf.text(participantDate, margin + 130, yPosition + 15);
//       pdf.line(margin + 130, yPosition + 20, margin + 170, yPosition + 20);
//       pdf.setFontSize(8);
//       pdf.text("Participant Signature", margin, yPosition + 25);
//       pdf.text("Date (Day/Month/Year)", margin + 130, yPosition + 25);
...
//       pdf.line(margin, yPosition + 20, margin + 120, yPosition + 20);
//       if (guardianDate) {
//         pdf.text(guardianDate, margin + 130, yPosition + 15);
//       }
//       pdf.line(margin + 130, yPosition + 20, margin + 170, yPosition + 20);
//       pdf.setFontSize(8);
//       pdf.text(
...
//       // Insurance section
//       pdf.setFontSize(10);
//       pdf.text("Diver Accident Insurance?", margin, yPosition);

//       // Place "NO" option
//       pdf.text("NO", margin + 60, yPosition);

//       // Place "YES" option
//       pdf.text("YES", margin + 80, yPosition);

//       // Draw X mark depending on selected option
//       if (hasInsurance === "no") {
//         pdf.text("X", margin + 55, yPosition); // next to NO
//       } else if (hasInsurance === "yes") {
//         pdf.text("X", margin + 75, yPosition); // next to YES
//       }

//       // Policy Number field
//       if (policyNumber) {
//         pdf.text(`Policy Number: ${policyNumber}`, margin + 100, yPosition);
//       }
...
//       pdf.save(
//         `PADI_Enriched_Air_Form_${participantName
...
//   //     formData.append("storeResort", storeResort)
//   //     formData.append("hasInsurance", hasInsurance)
//   //     formData.append("policyNumber", policyNumber)

//   //     const response = await fetch("/api/submit-enriched-air-form", {
//   //       method: "POST",
//   //       body: formData,
//   //     })
