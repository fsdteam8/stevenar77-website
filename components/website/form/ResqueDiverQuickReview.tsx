...
//   // Sample questions - replace with your actual Rescue Diver questions
//   const questions = [
//     {
//       id: 1,
...
//       try {
//         const logoBase64 = await fetchImageAsBase64("/images/pdf-logo.jpg");
//         pdf.addImage(logoBase64, "JPEG", margin, yPosition, 40, 25);
//         yPosition += 35;
//       } catch (logoError) {
//         console.log("Logo not loaded, using placeholder:", logoError);
//         // Fallback placeholder
//         pdf.setFillColor(200, 200, 200);
//         pdf.rect(margin, yPosition, 40, 25, "F");
//         pdf.setFontSize(8);
//         pdf.text("PADI LOGO", margin + 20, yPosition + 15, { align: "center" });
//         yPosition += 35;
//       }
...
//       pdf.text("Rescue Diver Course Online", pageWidth / 2, yPosition, {
//         align: "center",
//       });
//       yPosition += 8;

//       pdf.setFontSize(14);
//       pdf.text("Quick Review Answer Sheet", pageWidth / 2, yPosition, {
//         align: "center",
//       });
//       yPosition += 15;
...
//       pdf.setFontSize(10);
//       pdf.setFont("helvetica", "bold");
//       pdf.text("Selected answers are shown below.", margin, yPosition);
//       yPosition += 10;

//       // Name field
//       pdf.setFont("helvetica", "normal");
//       pdf.text("Name:", margin, yPosition);
//       pdf.text(participantName, margin + 20, yPosition);
//       pdf.line(margin + 20, yPosition + 2, margin + 100, yPosition + 2);
//       yPosition += 15;

//       // Questions - Show all questions and options, mark only selected ones
...
//         // Show all options with checkmarks only for selected ones
//         pdf.setFont("helvetica", "normal");
...
//           if (isSelected) {
//             // Draw filled checkbox for selected answers
//             pdf.rect(margin + 10, yPosition - 3, 3, 3);
//             pdf.line(margin + 11, yPosition - 2, margin + 12, yPosition - 1);
//             pdf.line(
//               margin + 12,
//               yPosition - 1,
//               margin + 13.5,
...
//             );
//           } else {
//             // Draw empty checkbox for unselected answers
//             pdf.rect(margin + 10, yPosition - 3, 3, 3);
//           }

//           // Add the option text
//           const optionLines = pdf.splitTextToSize(option, contentWidth - 20);
//           pdf.text(optionLines, margin + 18, yPosition);
//           yPosition += Math.max(optionLines.length * 4, 5) + 2;
//         });
//         yPosition += 8;
//       });
...
//       // Participant signature (always show)
//       pdf.setFont("helvetica", "normal");
//       pdf.setFontSize(10);
...
//       if (date) {
//         pdf.setFontSize(12);
//         pdf.text(date, margin + 120, yPosition + 15);
//       }
//       pdf.line(margin + 120, yPosition + 20, margin + 170, yPosition + 20);
//       pdf.setFontSize(8);
//       pdf.text("Date (DD/MM/YYYY)", margin + 120, yPosition + 25);

//       // Footer
//       yPosition += 40;
//       pdf.setFontSize(7);
//       pdf.text("PADI Rescue Diver Course - Quick Review", margin, yPosition);

//       // Save PDF
//       pdf.save(
//         `Rescue_Diver_Quick_Review_${participantName
...
//         {/* Form Content */}
//         <div className="print-area max-w-6xl mx-auto bg-white p-10 text-sm leading-relaxed font-serif shadow-lg">
//           {/* ---------------- Page 1 ---------------- */}
