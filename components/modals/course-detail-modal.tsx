      ...
      <div className="p-4 md:p-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4 space-y-4 md:space-y-0">
          ...
          <div className="md:text-right">
            ...
            <div className="flex items-center space-x-1 text-sm text-[#68706a] justify-start md:justify-end">
        ...
        <div className="mb-4 md:mb-6">
          ...
          <ul className="space-y-2">
            {course.courseIncludes.map((item, index) => (
              <li
                key={index}
                className="flex items-center space-x-2 text-[#68706a] text-sm md:text-base"
              >
                <div className="w-2 h-2 bg-[#0694a2] rounded-full flex-shrink-0"></div>
                <span>{item}</span>
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-[#68706a]">
            <div className="flex items-center space-x-2">
              ...
              <span className="break-all">{course.contactDate}</span>
            </div>
            <div className="flex items-center space-x-2">
